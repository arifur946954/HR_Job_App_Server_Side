...
namespace DataFactories.Infrastructure.business.reqform
{
    ...
    public async Task<object> SaveUpdate(string _mJsonData, string _dJsonData, string _tcJsonData, vmCmnParameter param)
    {
        ...
        string result1 = string.Empty, mstrRes = string.Empty;string result2 = string.Empty;
        try
        {
        ...
        public async Task<object> GetByID(vmCmnParameter cparam)
        {
            ...
            try
            {
              ...
              /*  else if (cparam.strId2 == "CAT000007" || cparam.strId2 == "CAT000008")
                {
                    wrkDtl = await OraGeneric_vmCmnParameter.ExecuteNonQueryOutClob(StoredProcedure.Ora_SpGet_WorkOrderDetailMediaById, ht, "gresult", StaticInfos.conStringOracle.ToString());
                }
                else if (cparam.strId2 == "CAT000006")
                {
                    wrkDtl = await OraGeneric_vmCmnParameter.ExecuteNonQueryOutClob(StoredProcedure.Ora_SpGet_WorkOrderDetailPrintById, ht, "gresult", StaticInfos.conStringOracle.ToString());
                }
                else if (cparam.strId2 == "CAT000003")
                {
                    wrkDtl = await OraGeneric_vmCmnParameter.ExecuteNonQueryOutClob(StoredProcedure.Ora_SpGet_WorkOrderDetailBuyingById, ht, "gresult", StaticInfos.conStringOracle.ToString());
                }*/
